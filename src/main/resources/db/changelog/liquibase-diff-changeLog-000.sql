...
CREATE TABLE SGV_USER (
    ...
    NOTIFICATION_TOKEN VARCHAR(200) NOT NULL,
...
--changeset gilberto:000.08:
CREATE SEQUENCE presence_confirmation_id_seq MINVALUE 1 START WITH 1 INCREMENT BY 1 CACHE 2;
CREATE TABLE SGV_PRESENCE_CONFIRMATION (
    ID NUMERIC(19,0) NOT NULL,
	CONFIRMED BOOLEAN,
    PASSENGER NUMERIC(19,0) NOT NULL,
    ROUTE NUMERIC(19,0) NOT NULL,
    CONSTRAINT SGV_PRESENCE_CONFIRMATION_PK PRIMARY KEY (ID)
);

ALTER TABLE SGV_PRESENCE_CONFIRMATION ADD CONSTRAINT FK_PRESENCE_PASSENGER FOREIGN KEY (PASSENGER) REFERENCES SGV_USER(ID);
ALTER TABLE SGV_PRESENCE_CONFIRMATION ADD CONSTRAINT FK_PRESENCE_ROUTE FOREIGN KEY (ROUTE) REFERENCES SGV_ROUTE(ID);
