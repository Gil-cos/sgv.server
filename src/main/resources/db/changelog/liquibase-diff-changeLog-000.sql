...
CREATE TABLE SGV_CONFIRMED_PASSENGERS (
	ID_ROUTE NUMERIC(19) NOT NULL,
	ID_PASSENGER NUMERIC(19) NOT NULL,
	CONSTRAINT SGV_CONFIRMED_PASSENGERS_PK PRIMARY KEY (ID_ROUTE, ID_PASSENGER)
);

ALTER TABLE SGV_CONFIRMED_PASSENGERS ADD CONSTRAINT FK_CP_ROUTE FOREIGN KEY (ID_ROUTE) REFERENCES SGV_ROUTE(ID);
ALTER TABLE SGV_CONFIRMED_PASSENGERS ADD CONSTRAINT FK_CP_PASSENGER FOREIGN KEY (ID_PASSENGER) REFERENCES SGV_USER(ID);
